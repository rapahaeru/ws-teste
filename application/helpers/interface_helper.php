...
function CurrentFunction(){
	...
	function getMobileOrContent($content,$contentMobile){
		if ($contentMobile != '' ){
			return htmlDecode($contentMobile);
		}else{
	...
	function getExtension($str,$chars){
		$return = substr($str, $chars);
		return $return;		
	}
	
	function getMediaExtension($str,$chars){
		$extension 		= getExtension($str,$chars);
		$extLower 		= strtolower($extension);
		if ($extLower != 'flv') $extLower = 'other'; 
		return $extLower; 
	}
?>