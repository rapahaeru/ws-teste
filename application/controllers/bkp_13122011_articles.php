		...
		if ($auth){
			...
			if ($parameters['1'] != '') {
				...
				if($site == 'trip'){
					...
					$topicsForMobile[4] = array('seo' => 'entrevistas','type' => 'secao');
					$topicsForMobile[5] = array('seo' => 'salada','type' => 'secao');
					$topicsForMobile[6] = array('seo' => 'cultura-pop','type' => 'assunto');
					$topicsForMobile[7] = array('seo' => 'esporte','type' => 'assunto');
					$topicsForMobile[8] = array('seo' => 'viagem','type' => 'assunto');
					...
					//var_dump($topicsForMobile);
 					...
 					for($x=0; $x< sizeof($topicsForMobile); $x++){
						...
						if ($topicsForMobile[$x]['type'] == 'assunto') {
							$returnTopic 				= $this->Article->getTopicBySeo($site,$topicsForMobile[$x]['seo']);
							if($returnTopic){
								$returnArr[$x]['id'] 		= $returnTopic[0]['id'];
								$returnArr[$x]['name'] 		= $returnTopic[0]['name'];
								$returnArr[$x]['seo'] 		= $returnTopic[0]['seo'];
								$returnArr[$x]['type'] 		= 'Topic';
							}
							
						}elseif ($topicsForMobile[$x]['type'] == 'secao'){
							$returnTopic 				= $this->Article->getSectionBySeo($site,$topicsForMobile[$x]['seo']);
							if($returnTopic){							
								$returnArr[$x]['id'] 		= $returnTopic[0]['id'];
								$returnArr[$x]['name'] 		= $returnTopic[0]['name'];
								$returnArr[$x]['seo'] 		= $returnTopic[0]['seo'];							
								$returnArr[$x]['type'] 		= 'section';
							}
						}
					...
					$topicsForMobile	= array();
					$topicsForMobile[0] = array('seo' => 'entrevistas','type' => 'secao');
					$topicsForMobile[1] = array('seo' => 'moda','type' => 'assunto');
					$topicsForMobile[2] = array('seo' => 'beleza','type' => 'assunto');
					$topicsForMobile[3] = array('seo' => 'ensaio','type' => 'secao');
					$topicsForMobile[4] = array('seo' => 'decoracao','type' => 'assunto');
					$topicsForMobile[5] = array('seo' => 'reportagens','type' => 'secao');
					...
					//var_dump($topicsForMobile);
 					...
 					for($x=0; $x< sizeof($topicsForMobile); $x++){
						...
						if ($topicsForMobile[$x]['type'] == 'assunto') {
							...
							if ($topicsForMobile[$x]['seo'] == 'trip-fm') $site = 'trip';
							else $site = 'tpm';
